...
public class AccountsActivity extends BaseActivity {
    ...
    private void updatePersonalizationControls(MsftAccountStore.MsftAccount active) {
        ...
        if (btnToggleChroma != null) btnToggleChroma.setEnabled(hasActive);
    }
    ...
    private void refreshUI() {
        ...
        if (active == null) {
            ...
            String privilege = getString(R.string.accounts_active_privilege);
            privilegesText.setText(privilege);
