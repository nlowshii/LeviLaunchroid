...
import okhttp3.OkHttpClient;
 ...
 public class MainActivity extends BaseActivity {
    ...
    private TextView launchAccountHint;
    ...
    private void initAccountHeader() {
        ...
        launchAccountHint = findViewById(R.id.launch_account_hint);
    ...
    private void refreshAccountHeaderUI() {
        ...
        if (active == null) {
            ...
            if (launchAccountHint != null) {
                launchAccountHint.setText(getString(R.string.sign_in));
                launchAccountHint.setTextColor(ContextCompat.getColor(this, R.color.text_secondary));
            }
            ...
            if (launchAccountHint != null) {
                launchAccountHint.setText(AccountTextUtils.displayNameOrNotSigned(this, active));
                launchAccountHint.setTextColor(ContextCompat.getColor(this, R.color.on_surface));
                ChromaTextEffect.apply(launchAccountHint, active.chromaNameEnabled);
            }
